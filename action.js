...
player1Dice.setAttribute("src", `Rolling_Rivals_TwoPlayer_Dice_Showdown/images/dice${randomVariable1}.png`);
player2Dice.setAttribute("src", `Rolling_Rivals_TwoPlayer_Dice_Showdown/images/dice${randomVariable2}.png`);
